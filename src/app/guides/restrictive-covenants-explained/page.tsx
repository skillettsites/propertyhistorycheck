    ...
    <>
      ...
      <main className="flex-1 bg-white">
        <article className="mx-auto max-w-3xl px-4 py-14 text-slate-700">
          ...
          <p>The Charges Register is where covenants live. Pulling the official copy is £3 from HM Land Registry directly, or it&apos;s included in our paid reports with a plain-English summary of every covenant flagged. See the <Link href="/title-register-check" className="text-blue-700 underline">title register check page</Link> for what else surfaces, and the <Link href="/property-history-check" className="text-blue-700 underline">free property check</Link> to scan the property before you commit.</p>
