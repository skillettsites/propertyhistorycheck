    ...
    <>
      <JsonLd
        data={[
          ...
          faqSchema([
            ...
            { q: "Where do I find the covenants on a property?", a: "They sit in the Charges Register (Section C) of the official copy of register entries from HM Land Registry. Anyone can buy a copy for £7 at gov.uk/search-property-information-land-registry, or your solicitor will pull one as part of conveyancing." },
          ]),
        ]}
      />
      <Header />
      <main className="flex-1 bg-white">
        <article className="mx-auto max-w-3xl px-4 py-14 text-slate-700">
          ...
          <p>The Charges Register is where covenants live. Pull the official copy for £7 from HM Land Registry directly to read every covenant in full. Our paid reports don&apos;t reproduce that document, they synthesise tenure, ownership and sale history from public data and point you to the £7 copy for the covenant detail. See the <Link href="/title-register-check" className="text-blue-700 underline">title register check page</Link> for what else surfaces, and the <Link href="/property-history-check" className="text-blue-700 underline">free property check</Link> to scan the property before you commit.</p>
