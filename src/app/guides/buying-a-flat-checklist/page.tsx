    ...
    <>
      ...
      <main className="flex-1 bg-white">
        <article className="mx-auto max-w-3xl px-4 py-14 text-slate-700">
          ...
          <p>The lease, the title register, the freeholder identity and the price paid by the current owner all show up on the official copy of register entries. £3 from HM Land Registry directly. Our paid reports don&apos;t reproduce the official copy, they synthesise tenure, ownership and sale history from public data and point you to the £3 download. See the <Link href="/title-register-check" className="text-blue-700 underline">title register check page</Link> for what we surface, and the <Link href="/guides/freehold-vs-leasehold" className="text-blue-700 underline">freehold vs leasehold guide</Link> for the bigger tenure picture.</p>
