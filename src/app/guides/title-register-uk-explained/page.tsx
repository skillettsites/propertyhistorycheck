    ...
    <>
      <JsonLd
        data={[
          ...
          faqSchema([
            { q: "How do I get a copy of a property's title register?", a: "Order it directly from HM Land Registry at gov.uk/search-property-information-land-registry for £7 per document. You'll get the title register and, separately, the title plan (also £7). Most properties in England and Wales are registered; about 13% remain unregistered, mostly in the hands of long-term owners." },
      ...
      <main className="flex-1 bg-white">
        <article className="mx-auto max-w-3xl px-4 py-14 text-slate-700">
          ...
          <p className="mt-4">The official copy of register entries is the legal record of who owns a property, what they paid, what they owe, and what restrictions sit on the title. It costs £7 from HM Land Registry, takes about an hour to order, and tells you more about the property than the estate agent will in a month. Almost no buyers read one before offering. The ones who do save themselves a lot of money.</p>
          ...
          <p>Three pieces of information from £7, before you offer. The 1923 covenant might block your loft conversion plans (or at least demand indemnity insurance). The £325,000 price paid in 2018 helps you anchor your offer against the asking price in 2026. The mortgage tells you the seller has a chain dependency.</p>
          ...
          <p>£7 from HM Land Registry directly for the official document. Our paid reports don&apos;t reproduce it, they synthesise tenure, ownership and sale history from public data and point you to the £7 copy for the full entries. See the <Link href="/title-register-check" className="text-blue-700 underline">title register check page</Link> for what we surface, and the <Link href="/property-history-check" className="text-blue-700 underline">free property check</Link> page for the wider risk picture.</p>
