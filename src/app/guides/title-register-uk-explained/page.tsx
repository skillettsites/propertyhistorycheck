    ...
    <>
      ...
      <main className="flex-1 bg-white">
        <article className="mx-auto max-w-3xl px-4 py-14 text-slate-700">
          ...
          <p>£3 from HM Land Registry directly for the official document. Our paid reports don&apos;t reproduce it, they synthesise tenure, ownership and sale history from public data and point you to the £3 copy for the full entries. See the <Link href="/title-register-check" className="text-blue-700 underline">title register check page</Link> for what we surface, and the <Link href="/property-history-check" className="text-blue-700 underline">free property check</Link> page for the wider risk picture.</p>
