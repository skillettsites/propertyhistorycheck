    ...
    <>
      ...
      <main className="flex-1 bg-white">
        <article className="mx-auto max-w-3xl px-4 py-14 text-slate-700">
          ...
          <p>The lease and the title register tell you everything. Years remaining, ground rent terms, restrictions on use, and the freeholder&apos;s identity all show up on the official copy. The £3 spend before offering is usually the best money you&apos;ll spend on a flat purchase. See our <Link href="/title-register-check" className="text-blue-700 underline">title register check page</Link> and the <Link href="/guides/short-lease-buying-a-flat" className="text-blue-700 underline">short lease guide</Link> for what to watch for.</p>
