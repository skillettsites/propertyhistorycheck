    ...
    <>
      ...
      <main className="flex-1 bg-white">
        <article className="prose mx-auto max-w-3xl px-4 py-12 text-slate-700">
          ...
          <p>HomeBuyerCheck.co.uk provides automated property reports for informational purposes only. The service is not a regulated legal service and is not a substitute for formal conveyancing searches conducted by a qualified solicitor.</p>
          ...
          <p>To the maximum extent permitted by law, HomeBuyerCheck&apos;s liability for any claim arising from a report is limited to the price paid for that report. We do not accept liability for decisions made on the basis of report data without independent verification by a qualified professional.</p>
