...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/llc-search`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/local-authority-search`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
