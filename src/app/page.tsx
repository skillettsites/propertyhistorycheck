        ...
        <section className="py-16 md:py-20 bg-slate-50">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <ul className="mt-8 grid sm:grid-cols-2 gap-3">
              ...
              <li><Link href="/blog/cheapest-property-check-uk" className="block rounded-2xl border border-slate-200 bg-white p-4 hover:border-blue-300"><span className="font-bold text-slate-900">Cheapest UK property check ranked →</span><span className="block text-sm text-slate-600 mt-1">£7 to £450, what each price actually buys you.</span></Link></li>
              ...
              <li><Link href="/calculators" className="block rounded-2xl border border-slate-200 bg-white p-4 hover:border-blue-300"><span className="font-bold text-slate-900">Property buying calculators →</span><span className="block text-sm text-slate-600 mt-1">Cost of buying, stamp duty, conveyancing and survey, work out every fee.</span></Link></li>
            </ul>
          </div>
        </section>
